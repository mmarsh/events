...
I've tried it most extensively in Chrome, some testing in IE 11
...
--------------------
  ...
  - Expanded build process. Code coverage, static code analysis, run unit tests on multiple browsers, all of these would be great
